...
- [x] T10 - Quality
  - What changed: Added MAE/WAPE metrics on indicators, fallback usage reporting, README guidance, GUIDE.md with reporting instructions, and a CSV report for actual vs predicted indicators.
